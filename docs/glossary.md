...
Medical and technical terms used throughout this knowledge base.
...
Devices and methods that supplement or replace speech. Includes communication boards, speech-generating devices, and eye-gaze systems. See [Equipment & Devices](./management/equipment.md).
...
Type characterized by involuntary, uncontrolled movements.
...
**Baclofen**
A muscle relaxant that reduces spasticity. Available as oral medication or via intrathecal pump. See [Spasticity Management](./management/spasticity.md).

**Botulinum toxin (Botox)**
Injectable medication that reduces spasticity in targeted muscles. Effects last 3-6 months. See [Spasticity Management](./management/spasticity.md).
...
**Diplegia**
Cerebral palsy primarily affecting the legs more than the arms.
...
**Hemiplegia**
Cerebral palsy affecting one side of the body (arm and leg on the same side).

**Hypertonia**
Increased muscle tone (stiffness). Includes spasticity.
...
Surgically implanted pump delivering baclofen directly to spinal fluid. See [Spasticity Management](./management/spasticity.md).
...
**Neurologist**
Physician specializing in nervous system disorders. Manages seizures and some spasticity medications.

**Neuropsychologist**
Psychologist specializing in brain-behavior relationships. Conducts cognitive and autism assessments. See [Cognitive Assessment](./assessment/cognitive.md).
...
External device supporting body structure. Includes AFOs, hand splints, trunk supports. See [Equipment & Devices](./management/equipment.md).

**Orthotist**
Specialist who designs, fabricates, and fits orthoses.
...
**Physiatrist**
Physician specializing in Physical Medicine and Rehabilitation (PM&R). Key coordinator for cerebral palsy care. See [Physiatrist Role](./management/physiatrist-role.md).

**PM&R (Physical Medicine and Rehabilitation)**
Medical specialty focused on restoring function. Physiatrists are PM&R physicians.
...
**Quadriplegia**
Cerebral palsy affecting all four limbs and usually the trunk.
...
Most common type, characterized by stiff, tight muscles.
