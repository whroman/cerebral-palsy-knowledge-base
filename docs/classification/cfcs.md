...
**"The Communication Function Classification System (CFCS) provides 5 levels (CFCS I, II, III, IV, V) to describe everyday communication performance."** [^3]

**"The CFCS is a valid measure in cerebral palsy that assesses everyday communication (not optimal communication). The CFCS is a simple, five-point ordinal classification system, and was designed to be analogous and complementary to the GMFCS and MACS."** [^3]
...
**Reference for the initial CFCS Development: Hidecker, M.J.C., Paneth, N., Rosenbaum, P.L., Kent, R.D., Lillie, J., Eulenberg, J.B., Chester, K., Johnson, B., Michalsen, L., Evatt, M., & Taylor, K.** [^4]

**"CFCS is a tool developed with support from the National Institute of Health (NIH), the Cerebral Palsy International Research Foundation, and The Hearst Foundation."** [^3]

## References

[^1]: [Developing and validating the Communication Function Classification System for individuals with cerebral palsy - PubMed](https://pubmed.ncbi.nlm.nih.gov/21707596/)
[^2]: [Communication Function Classification System (CFCS) - Cerebral Palsy Alliance Australia](https://cerebralpalsy.org.au/cerebral-palsy/communication-function-classification-system/)
[^3]: [Communication Function Classification System - Cerebral Palsy Alliance Research Foundation](https://cparf.org/what-is-cerebral-palsy/severity-of-cerebral-palsy/communication-function-classification-system/)
[^4]: [CFCS – Communication Function Classification Systems Official Website](http://cfcs.us/)